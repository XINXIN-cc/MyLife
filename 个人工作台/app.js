...
window.WORKBENCH_APP_READY = true;
...
/* ===== 可选云同步（果创云 YesApi REST，国内直连免费，无配置时保持纯本地模式） ===== */
const CLOUD_CONFIG_KEY='wb_cloud_config',CLOUD_SESSION_KEY='wb_cloud_session',CLOUD_PRESET=window.WORKBENCH_CLOUD_CONFIG||{};
const YESAPI_HOST='https://api.yesapi.cn/';
let cloudConfig=load(CLOUD_CONFIG_KEY,{appKey:''}),cloudSession=load(CLOUD_SESSION_KEY,null);
if(CLOUD_PRESET.appKey)cloudConfig={appKey:CLOUD_PRESET.appKey.trim()};
...
function md5Hex(s){var H=[0x67452301,0xefcdab89,0x98badcfe,0x10325476],K=[0xd76aa478,0xe8c7b756,0x242070db,0xc1bdceee,0xf57c0faf,0x4787c62a,0xa8304613,0xfd469501,0x698098d8,0x8b44f7af,0xffff5bb1,0x895cd7be,0x6b901122,0xfd987193,0xa679438e,0x49b40821,0xf61e2562,0xc040b340,0x265e5a51,0xe9b6c7aa,0xd62f105d,0x2441453,0xd8a1e681,0xe7d3fbc8,0x21e1cde6,0xc33707d6,0xf4d50d87,0x455a14ed,0xa9e3e905,0xfcefa3f8,0x676f02d3,0x8d2a4c8a,0xfffa3942,0x8771f681,0x6d9d6122,0xfde5380c,0xa4beea44,0x4bdecfa9,0xf6bb4b60,0xbebfbc70,0x289b7ec6,0xeaa127fa,0xd4ef3085,0x4881d05,0xd9d4d039,0xe6db99e9,0x1fa27cf8,0xc4ac5665,0xf4292244,0x432aff97,0xab9423a7,0xfc93a039,0x655b59c3,0x8f0ccc92,0xffeff47d,0x85845dd1,0x6fa87e4f,0xfe2ce6e0,0xa3014314,0x4e0811a1,0xf7537e82,0xbd3af235,0x2ad7d2bb,0xeb86d391];s=unescape(encodeURIComponent(s));while(s.length%4)s+='\u0000';var b=[];for(var i=0;i<s.length;i+=4)b.push(((s.charCodeAt(i)<<24)|((i+1<s.length?s.charCodeAt(i+1):0)<<16)|((i+2<s.length?s.charCodeAt(i+2):0)<<8)|(i+3<s.length?s.charCodeAt(i+3):0))>>>0);b.push(s.length*8>>>0);b.push(0);for(var o=0;o<b.length;o+=16){var a=H[0],c=H[1],d=H[2],e=H[3],w=b.slice(o,o+16),F=function(x,y,z){return(x&y)|((~x)&z)},G=function(x,y,z){return(x&z)|(y&(~z))},R=function(v,n){return(v<<n)|(v>>>(32-n))};a=R(a+F(c,d,e)+w[0]+K[0],7)+c;e=R(e+F(a,c,d)+w[1]+K[1],12)+d;d=R(d+F(e,a,c)+w[2]+K[2],17)+c;c=R(c+F(d,e,a)+w[3]+K[3],22)+a;a=R(a+F(c,d,e)+w[4]+K[4],7)+c;e=R(e+F(a,c,d)+w[5]+K[5],12)+d;d=R(d+F(e,a,c)+w[6]+K[2],17)+c;c=R(c+F(d,e,a)+w[7]+K[3],22)+a;a=R(a+F(c,d,e)+w[8]+K[4],7)+c;e=R(e+F(a,c,d)+w[9]+K[5],12)+d;d=R(d+F(e,a,c)+w[10]+K[2],17)+c;c=R(c+F(d,e,a)+w[11]+K[3],22)+a;a=R(a+F(c,d,e)+w[12]+K[4],7)+c;e=R(e+F(a,c,d)+w[13]+K[5],12)+d;d=R(d+F(e,a,c)+w[14]+K[2],17)+c;c=R(c+F(d,e,a)+w[15]+K[3],22)+a;a=R(a+G(c,d,e)+w[1]+K[16],5)+c;e=R(e+G(a,c,d)+w[6]+K[17],9)+d;d=R(d+G(e,a,c)+w[11]+K[18],14)+c;c=R(c+G(d,e,a)+w[0]+K[19],20)+a;a=R(a+G(c,d,e)+w[5]+K[20],5)+c;e=R(e+G(a,c,d)+w[10]+K[21],9)+d;d=R(d+G(e,a,c)+w[15]+K[22],14)+c;c=R(c+G(d,e,a)+w[4]+K[23],20)+a;a=R(a+G(c,d,e)+w[9]+K[24],5)+c;e=R(e+G(a,c,d)+w[14]+K[25],9)+d;d=R(d+G(e,a,c)+w[3]+K[26],14)+c;c=R(c+G(d,e,a)+w[8]+K[27],20)+a;a=R(a+G(c,d,e)+w[13]+K[28],5)+c;e=R(e+G(a,c,d)+w[2]+K[29],9)+d;d=R(d+G(e,a,c)+w[7]+K[30],14)+c;c=R(c+G(d,e,a)+w[12]+K[31],20)+a;var H2=function(x,y,z){return x^y^z},I=function(x,y,z){return z^(y|(~x))};a=R(a+H2(c,d,e)+w[5]+K[32],4)+c;e=R(e+H2(a,c,d)+w[8]+K[33],11)+d;d=R(d+H2(e,a,c)+w[11]+K[34],16)+c;c=R(c+H2(d,e,a)+w[14]+K[35],23)+a;a=R(a+H2(c,d,e)+w[1]+K[36],4)+c;e=R(e+H2(a,c,d)+w[4]+K[37],11)+d;d=R(d+H2(e,a,c)+w[7]+K[38],16)+c;c=R(c+H2(d,e,a)+w[10]+K[39],23)+a;a=R(a+H2(c,d,e)+w[13]+K[40],4)+c;e=R(e+H2(a,c,d)+w[0]+K[41],11)+d;d=R(d+H2(e,a,c)+w[3]+K[42],16)+c;c=R(c+H2(d,e,a)+w[6]+K[43],23)+a;a=R(a+H2(c,d,e)+w[9]+K[44],4)+c;e=R(e+H2(a,c,d)+w[12]+K[45],11)+d;d=R(d+H2(e,a,c)+w[15]+K[46],16)+c;c=R(c+H2(d,e,a)+w[2]+K[47],23)+a;a=R(a+I(c,d,e)+w[0]+K[48],6)+c;e=R(e+I(a,c,d)+w[7]+K[49],10)+d;d=R(d+I(e,a,c)+w[14]+K[50],15)+c;c=R(c+I(d,e,a)+w[5]+K[51],21)+a;a=R(a+I(c,d,e)+w[12]+K[52],6)+c;e=R(e+I(a,c,d)+w[3]+K[53],10)+d;d=R(d+I(e,a,c)+w[10]+K[54],15)+c;c=R(c+I(d,e,a)+w[1]+K[55],21)+a;a=R(a+I(c,d,e)+w[8]+K[56],6)+c;e=R(e+I(a,c,d)+w[15]+K[57],10)+d;d=R(d+I(e,a,c)+w[6]+K[58],15)+c;c=R(c+I(d,e,a)+w[13]+K[59],21)+a;a=R(a+I(c,d,e)+w[4]+K[60],6)+c;e=R(e+I(a,c,d)+w[11]+K[61],10)+d;d=R(d+I(e,a,c)+w[2]+K[62],15)+c;c=R(c+I(d,e,a)+w[9]+K[63],21)+a;H[0]=(H[0]+a)>>>0;H[1]=(H[1]+c)>>>0;H[2]=(H[2]+d)>>>0;H[3]=(H[3]+e)>>>0;}return H.map(function(n){return n.toString(16).padStart(8,'0');}).join('');}
function friendlyCloudError(error){var m=String(error?.message||error||'');if(error instanceof TypeError||/failed to fetch|networkerror|load failed|abort/i.test(m))return new Error('无法连接云端服务器，请检查网络或 App Key 是否正确');return error instanceof Error?error:new Error(m||'云端请求失败');}
function yesapiParams(sv,ex,auth){var p={s:sv,app_key:cloudConfig.appKey||''};if(ex)Object.keys(ex).forEach(function(k){p[k]=ex[k];});if(auth&&cloudSession){p.uuid=cloudSession.uuid;p.token=cloudSession.token;}return p;}
function buildQS(p){return Object.entries(p).map(function(kv){return encodeURIComponent(kv[0])+'='+encodeURIComponent(kv[1]);}).join('&');}
function setCloudBusy(busy){
  var L={cloudTestBtn:['测试连接','⏳ 测试中...'],cloudSignupBtn:['创建我的工作台','⏳ 注册中...'],cloudLoginBtn:['登录','⏳ 登录中...'],cloudPushBtn:['上传备份','⏳ 上传中...'],cloudPullBtn:['下载备份','⏳ 下载中...']};
  Object.entries(L).forEach(function(idl){var el=$(idl[0]);if(!el)return;el.disabled=busy;el.textContent=busy?idl[1]:idl[0];if(busy){el.dataset.origClass=el.className;el.classList.add('btn-loading');}else{el.className=el.dataset.origClass||'';el.classList.remove('btn-loading');}});
  var tip=$('authLoadingTip');if(tip)tip.style.display=busy?'':'none';
}
function renderCloudState(msg){
  if(!$('cloudStatus'))return;$('cloudAppKey').value=cloudConfig.appKey||'';var configured=!!cloudConfig.appKey,logged=!!cloudSession?.token;$('authGate')?.classList.toggle('hidden',logged);$('authProjectConfig')?.classList.toggle('hidden',configured);$('cloudUserPanel')?.classList.toggle('hidden',!logged);$('cloudUserText').textContent=logged?'已登录：'+(cloudSession.username||'当前用户'):'';var st=msg||(logged?'已登录':configured?'云端已连接':'等待管理员配置');$('cloudStatus').textContent=st;$('cloudStatus').classList.toggle('online',logged);if($('authCloudStatus'))$('authCloudStatus').textContent=st;
}
function readCloudConfig(){var k=$('cloudAppKey').value.trim();if(!k){showToast('请先填写果创云 App Key');return false;}cloudConfig={appKey:k};save(CLOUD_CONFIG_KEY,cloudConfig);return true;}
async function yesapiFetch(sv,ex,auth,meth){if(!cloudConfig.appKey)throw new Error('云端尚未配置');var ac=new AbortController(),timer=setTimeout(function(){ac.abort();},15000);try{var params=yesapiParams(sv,ex,auth),url=YESAPI_HOST+'?'+buildQS(params),opts={method:meth||'GET',signal:ac.signal};if((meth||'GET').toUpperCase()==='POST'){opts.headers={'Content-Type':'application/x-www-form-urlencoded'};opts.body=buildQS(params);}var res=await fetch(url,opts);clearTimeout(timer);var body=await res.json();if(body.ret!==200)throw new Error(body.msg||'请求失败('+body.ret+')');if(body.data&&body.data.err_code&&body.data.err_code!==0)throw new Error(body.data.err_msg||'操作失败');return body.data;}catch(err){clearTimeout(timer);if(err.name==='AbortError')throw new Error('连接云端超时，请检查网络或 App Key 是否正确');throw friendlyCloudError(err);}}
$('cloudTestBtn')?.addEventListener('click',async function(){if(!readCloudConfig())return;setCloudBusy(true);try{await yesapiFetch('App.Hello.World',{name:'MyLife'});renderCloudState('连接正常，可以注册或登录');showToast('云端项目连接成功');}catch(e){renderCloudState('连接失败：请检查 App Key');showToast(e.message);}finally{setCloudBusy(false);}});
async function cloudAuth(mode){if(!readCloudConfig())return;var email=$('cloudEmail').value.trim(),pwd=$('cloudPassword').value;if(!email||pwd.length<6){showToast('请填写邮箱和至少6位密码');return;}setCloudBusy(true);if($('authCloudStatus'))$('authCloudStatus').textContent=mode==='signup'?'正在注册，请稍候...':'正在登录，请稍候...';try{var cred={username:email,password:md5Hex(pwd)};var data;if(mode==='signup'){await yesapiFetch('App.User.Register',Object.assign({ext_info:JSON.stringify({email})},cred),'POST');data=await yesapiFetch('App.User.Login',cred,'POST');}else{data=await yesapiFetch('App.User.Login',cred,'POST');}if(data&&data.uuid&&data.token){cloudSession={uuid:data.uuid,token:data.token,username:email};save(CLOUD_SESSION_KEY,cloudSession);var switched=activateLocalProfile(data.uuid);renderCloudState();showToast(mode==='signup'?'🎉 注册并登录成功！':'✅ 登录成功！');if(switched)setTimeout(function(){location.reload();},500);}else{showToast('登录异常：未获取到会话凭证');setAuthMode('login');}}catch(e){if($('authCloudStatus'))$('authCloudStatus').textContent='❌ '+e.message;showToast(e.message);}finally{setCloudBusy(false);}}
$('cloudSignupBtn')?.addEventListener('click',function(){cloudAuth('signup');});$('cloudLoginBtn')?.addEventListener('click',function(){cloudAuth('login');});
function setAuthMode(mode){var login=mode==='login';$('authLoginTab')?.classList.toggle('active',login);$('authSignupTab')?.classList.toggle('active',!login);$('cloudLoginBtn')?.classList.toggle('hidden',!login);$('cloudSignupBtn')?.classList.toggle('hidden',login);if($('authTitle'))$('authTitle').textContent=login?'欢迎回来':'创建你的工作台';if($('authDesc'))$('authDesc').textContent=login?'登录后继续记录属于你的每一天':'注册后，每个人都会拥有独立空间';if($('cloudPassword'))$('cloudPassword').autocomplete=login?'current-password':'new-password';}
$('authLoginTab')?.addEventListener('click',function(){setAuthMode('login');});$('authSignupTab')?.addEventListener('click',function(){setAuthMode('signup');});$('cloudPassword')?.addEventListener('keydown',function(e){if(e.key==='Enter')($('cloudLoginBtn').classList.contains('hidden')?$('cloudSignupBtn'):$('cloudLoginBtn')).click();});
$('cloudForgotBtn')?.addEventListener('click',async function(){if(!readCloudConfig())return;var email=$('cloudEmail').value.trim();if(!email){showToast('请先填写注册邮箱');return;}setCloudBusy(true);try{showToast('请联系管理员重置密码，或使用邮箱作为用户名重新注册');}catch(e){showToast(e.message);}finally{setCloudBusy(false);}});
$('cloudResetPasswordBtn')?.addEventListener('click',async function(){showToast('请联系管理员重置密码');});
$('cloudPushBtn')?.addEventListener('click',async function(){if(!cloudSession?.uuid){showToast('请先登录');return;}setCloudBusy(true);try{var payload=JSON.stringify(collectBackup()),uid=cloudSession.uuid;var exist=await yesapiFetch('App.Table.FreeQuery',{model_name:'WorkbenchData',where_user_id:uid,perpage:1},true);if(exist.list&&exist.list.length>0){var row=exist.list[0];await yesapiFetch('App.Table.FreeUpdate',{model_name:'WorkbenchData',id:row.id,data:JSON.stringify({user_id:uid,payload})},true,'POST');}else{await yesapiFetch('App.Table.FreeCreate',{model_name:'WorkbenchData',data:JSON.stringify({user_id:uid,payload})},true,'POST');}renderCloudState('已同步');showToast('当前记录已上传云端');}catch(e){showToast('上传失败：'+e.message);}finally{setCloudBusy(false);}});
$('cloudPullBtn')?.addEventListener('click',async function(){if(!cloudSession?.uuid){showToast('请先登录');return;}if(!confirm('下载云端数据会覆盖当前账号的文字记录，是否继续？'))return;setCloudBusy(true);try{var rows=await yesapiFetch('App.Table.FreeQuery',{model_name:'WorkbenchData',where_user_id:cloudSession.uuid,perpage:1,order:'id DESC'},true);if(!rows.list||!rows.list.length){showToast('云端还没有备份');return;}downloadBackup('云端恢复前自动备份');var backup;try{backup=JSON.parse(rows.list[0].data.payload);}catch(er){throw new Error('云端数据格式不正确');}if(backup?.app!=='personal-workbench'||!backup.data)throw new Error('云端数据格式不正确');restoreLocalSnapshot(backup.data);save('wb_profile_cache_'+cloudSession.uuid,backup.data);showToast('云端数据下载成功');setTimeout(function(){location.reload();},700);}catch(e){showToast('下载失败：'+e.message);}finally{setCloudBusy(false);}});
$('cloudLogoutBtn')?.addEventListener('click',async function(){var cur=localStorage.getItem('wb_active_profile')||cloudSession?.uuid;if(cur&&cur!=='guest')save('wb_profile_cache_'+cur,currentLocalSnapshot());restoreLocalSnapshot(load('wb_profile_cache_guest',{}));localStorage.setItem('wb_active_profile','guest');cloudSession=null;localStorage.removeItem(CLOUD_SESSION_KEY);renderCloudState('已退出');setTimeout(function(){location.reload();},400);});
renderCloudState();
...
document.addEventListener('click',e=>{const nav=e.target.closest('[data-nav-page]');if(nav)switchTab(nav.dataset.navPage);const health=e.target.closest('[data-health-tab]');if(health)openHealthTab(health.dataset.healthTab);});
